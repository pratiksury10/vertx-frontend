...
//     navigate('/pitch', { state: { selectedIndustry } });
//   };
...
const handleContinue = async () => {
    ...
    try {
      ...
      navigate('/pitch', { state: { selectedStage, selectedCountry, selectedAmount, selectedRevenue, selectedIndustry } });
    } catch (error) {
       ...
       <div className="w-[1580px] h-[832px] bg-gradient-to-b from-[#0F0C29] via-[#08080d] to-[#0b0b3f] text-white flex flex-col items-center justify-center p-6">
          ...
          <div className="absolute w-[572px] h-[54px] top-[170px] left-[340px] mr-80 text-white space-y-3">
            ...
            <div className="mt-2 flex gap-2">
                ...
                selectedIndustry.map((industry, index) => (
                    <span
                    key={index}
                    className="inline-flex items-center px-3 py-1 text-sm font-medium gradient-bg text-white gradient-badge"
                    >
                    {industry.trim()} 
                ...
                <span
                    className="inline-flex items-center px-3 py-1 text-sm font-medium  text-white gradient-badge"
                >
                    {selectedIndustry}
                </span>
                )}
            ...
            {/* Back Button */}
                <button className="relative w-[33px] h-[17px] font-inter font-normal text-[14px] leading-[100%] text-white" onClick={() => navigate("/industry")}>
                   Back
                </button>
